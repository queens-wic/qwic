    ...
    <div>
      <div className="lg:h-4/6 h-auto flex flex-col text-center justify-center items-center relative">
        ...
        <div className="relative">
          <div className="z-10 absolute top-20 -left-44 w-3/6 h-3/6  bg-light-pink rounded-full mix-blend-multiply filter blur-2xl opacity-75 animate-blob"></div>
          <div className="z-10 absolute bottom-0 -right-4 w-3/6 h-3/6  bg-light-blue rounded-full mix-blend-multiply filter blur-2xl opacity-75 animate-blob animation-delay-2000"></div>
          <div className="z-10 absolute left-3/4 w-96 h-96  bg-light-purple rounded-full filter mix-blend-multiply blur-2xl opacity-75 animate-blob animation-delay-4000"></div>
