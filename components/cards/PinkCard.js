...
const PinkCard = ({ title, desc, cta, link, img }) => {
  return (
    <div className="relative h-full flex-1 ml-5 mb-10 flex-grow">
      {/* Background Box */}
      <div className="absolute inset-0 z-0 bg-dark-pink rounded-2xl transform -translate-x-5 translate-y-5"></div>
      {/* Main Content Box */}
      <div className="relative flex flex-col h-full border border-black bg-light-pink justify-between rounded-2xl p-6 z-10 w-full">
