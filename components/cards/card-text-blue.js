...
const CardTextBlue = ({title, body, img, more}) => 

    (
      
      <div className="relative w-[250px] h-[350px]">

        <div className="absolute top-0 left-5 z-40 w-[225px] h-[275px] rounded-2xl border-1 border-black bg-light-blue">
        ...
        <div className="absolute top-5 left-0 z-30 w-[225px] h-[275px] rounded-2xl bg-dark-blue"></div>
