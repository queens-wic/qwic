...
const ResourceBoxPurple = ({ title, description, img, link }) => (
  <div className="relative w-[325px] h-[375px]">
    <div className="absolute top-0 left-5 z-40 w-[325px] h-[375px] rounded-2xl border-1 border-black bg-light-purple">
      <div className="m-6">
    ...
    <div className="absolute top-5 left-0 z-30 w-[325px] h-[375px] rounded-2xl bg-dark-purple"></div>
  </div>
);
